...
// Declaration of a class named "ProductCatalog".
    ...
    // Assuming the SKU is the product itemName, replace with getSKU() if you have SKU as a property
    public Product searchProductByName(String itemName) {
        // Declaration of a public method "searchProductByName" that takes a parameter of type String.

        for (Product product : products) {
            // Starting a for-each loop to iterate over the products in the list.

            if (product.fetchName().equals(itemName)) {
                // Checking if the itemName of the current product matches the provided itemName.
    ...
    public List<Product> listAllProducts() {
        // Declaration of a public method "listAllProducts" that returns a List<Product>.
    ...
    public void insertProducts(List<Product> newProducts) {
        // Declaration of a public method "insertProducts" that takes a parameter of type List<Product>.
